...
conditionalPanel(
  ...
  checkboxInput("join_touching",
                ...
                value = TRUE),
  actionButton("pause_run", "Pause ASU Run")
)
...
observeEvent(input$process, {
  ...
  withProgress(message = "Running ASU initialisation…", value = 0, {
    ...
    res <- if (algo_choice == "orig") {
      ...
      run_tract_hunter(
        ...
        verbose       = TRUE,
        pause_check   = function() pause_flag()
      )
    }
    pause_flag(FALSE)
  ...
  if (paused) {
    showNotification("ASU run paused - partial results saved.", type = "message")
  }
