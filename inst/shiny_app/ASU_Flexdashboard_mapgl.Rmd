...
shiny::conditionalPanel(
  ...
  shiny::tagList(
    ...
    shiny::numericInput("cpsat_incumbent_stall_seconds", "Incumbent stall limit (sec)", value = 600, min = 0, step = 30),
...
kwargs = dict(
    ...
    root_separator_max_size=6,

    root_separator_clause_limit=5000,
    root_separator_target_limit=1000,
